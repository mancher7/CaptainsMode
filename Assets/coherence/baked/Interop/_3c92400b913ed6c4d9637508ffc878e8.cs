...
namespace Coherence.Generated
{
    ...
    public struct _3c92400b913ed6c4d9637508ffc878e8 : IEntityInput, IEquatable<_3c92400b913ed6c4d9637508ffc878e8>
    {
        ...
        public static unsafe _3c92400b913ed6c4d9637508ffc878e8 FromInterop(System.IntPtr data, System.Int32 dataSize)
        {
            if (dataSize != 0) {
            ...
            var orig = new _3c92400b913ed6c4d9637508ffc878e8();
        ...
        public _3c92400b913ed6c4d9637508ffc878e8(
        Entity entity,
        long frame,
        bool isRemoteInput)
        {
        ...
        public bool Equals(_3c92400b913ed6c4d9637508ffc878e8 other)
        {
            return true;
        }

        public static void Serialize(_3c92400b913ed6c4d9637508ffc878e8 inputData, IOutProtocolBitStream bitStream)
        {
        }

        public static _3c92400b913ed6c4d9637508ffc878e8 Deserialize(IInProtocolBitStream bitStream, Entity entity, long frame)
        {

            return new _3c92400b913ed6c4d9637508ffc878e8()
            {
                Entity = entity,
                Frame = frame,
                isRemoteInput = true
