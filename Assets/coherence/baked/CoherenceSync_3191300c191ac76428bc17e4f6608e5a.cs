...
namespace Coherence.Generated
{
    ...
    public class Binding_3191300c191ac76428bc17e4f6608e5a_e3601d08f9b44a329a834528cd2ce63c : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_3191300c191ac76428bc17e4f6608e5a : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_3191300c191ac76428bc17e4f6608e5a>();
        
        private global::UnityEngine.UI.Selectable _3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da_CommandTarget;
        
        private InputBuffer<_3191300c191ac76428bc17e4f6608e5a> inputBuffer;
        private _3191300c191ac76428bc17e4f6608e5a currentInput;
        ...
        {
			["e3601d08f9b44a329a834528cd2ce63c"] = new Binding_3191300c191ac76428bc17e4f6608e5a_e3601d08f9b44a329a834528cd2ce63c(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_3191300c191ac76428bc17e4f6608e5a()
        {
            bakedCommandBindings.Add("f6bb564de29b44739afeb0033faa61da", BakeCommandBinding__3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da);
        }
        ...
        private void BakeCommandBinding__3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da(CommandBinding commandBinding, CommandsHandler commandsHandler)
        {
            _3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da_CommandTarget = (global::UnityEngine.UI.Selectable)commandBinding.UnityComponent;
            commandsHandler.AddBakedCommand("UnityEngine.UI.Selectable.Select", "()", SendCommand__3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da, ReceiveLocalCommand__3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da, MessageTarget.All, _3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da_CommandTarget, false);
        }
        
        private void SendCommand__3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da(MessageTarget target, ChannelID channelID, object[] args)
        {
            var command = new _3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da();
            
        
            client.SendCommand(command, target, entityId, channelID);
        }
        
        private void ReceiveLocalCommand__3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da(MessageTarget target, ChannelID _, object[] args)
        {
            var command = new _3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da();
            
            
            ReceiveCommand__3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da(command);
        }

        private void ReceiveCommand__3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da(_3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da command)
        {
            var target = _3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da_CommandTarget;
        ...
        public override void ReceiveCommand(IEntityCommand command)
        {
            switch (command)
            {
                case _3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da castedCommand:
                    ReceiveCommand__3191300c191ac76428bc17e4f6608e5a_f6bb564de29b44739afeb0033faa61da(castedCommand);
                    break;
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_3191300c191ac76428bc17e4f6608e5a Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_3191300c191ac76428bc17e4f6608e5a>();
            this.bridge = bridge;
            this.entityId = entityId;
            this.client = client;        
            coherenceInput = input;
            inputBuffer = new InputBuffer<_3191300c191ac76428bc17e4f6608e5a>(coherenceInput.InitialBufferSize, coherenceInput.InitialInputDelay, coherenceInput.UseFixedSimulationFrames);
        ...
        public override void SendInputState()
        {
            ...
            while (inputBuffer.DequeueForSending(currentSimulationFrame, out long frameToSend, out _3191300c191ac76428bc17e4f6608e5a input, out bool differs))
            {
        ...
        private bool GetButton(string name, long? simulationFrame)
        {
            ...
            inputBuffer.TryGetInput(frame, out _3191300c191ac76428bc17e4f6608e5a input);
        ...
        {
            var input = (_3191300c191ac76428bc17e4f6608e5a)entityInput;
