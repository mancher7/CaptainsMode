...
namespace Coherence.Generated
{
    ...
    public class Binding_de225920e18d69141b9f2948f155bf5c_a3dfa4696c47469e9e6f033f519830fc : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_de225920e18d69141b9f2948f155bf5c : CoherenceSyncBaked
    {
        ...
        {
			["a3dfa4696c47469e9e6f033f519830fc"] = new Binding_de225920e18d69141b9f2948f155bf5c_a3dfa4696c47469e9e6f033f519830fc(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_de225920e18d69141b9f2948f155bf5c()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_de225920e18d69141b9f2948f155bf5c Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_de225920e18d69141b9f2948f155bf5c>();
            this.bridge = bridge;
